                      ...
                      <div class="block mb-0">
                        ...
                        <div class="block-content block-content-full">
                          <div class="row g-sm text-center mb-2">
                            <div class="col-6 mb-1">
                              <a class="d-block py-3 bg-body-dark fw-semibold text-dark" data-action="header_style_dark"
                                data-toggle="layout" href="javascript:void(0)"> تاریک </a>
                            </div>
                            <div class="col-6 mb-1">
                              <a class="d-block py-3 bg-body-dark fw-semibold text-dark"
                                data-action="header_style_light" data-toggle="layout" href="javascript:void(0)">روشن</a>
                            </div>
                          </div>
                        </div>
                        <!-- END Header -->
            ...
            <ul class="nav-main-submenu">
              ...
              <li v-if="permissions.getpay" class="nav-main-item">
                <RouterLink class="nav-main-link" to="/acc/persons/receive/list">
                  ...
                  <RouterLink to="/acc/persons/receive/mod/" class="nav-main-link-badge badge rounded-pill bg-primary">+
                  </RouterLink>
                </RouterLink>
              </li>
              <li v-if="permissions.getpay" class="nav-main-item">
