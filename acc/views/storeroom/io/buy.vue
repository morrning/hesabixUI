    ...
    <div class="block-content pt-1 pb-3">
      <div class="row">
        ...
        <div class="col-sm-12 col-md-4">
          ...
          <input disabled="disabled" readonly="readonly" v-model="this.ticket.store.des" type="text" class="form-control">
        </div>
        <div class="col-sm-12 col-md-4">
          <label class="form-label">خریدار</label>
          <input disabled="disabled" readonly="readonly" v-model="this.ticket.person.des" type="text" class="form-control">
        </div>
      </div>
      <div class="row mt-1">
