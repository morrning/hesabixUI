  ...
  <div class="block block-content-full ">
    <div id="fixed-header" class="block-header block-header-default bg-gray-light pt-2 pb-1">
      ...
      <div class="block-options">
        ...
        <router-link to="/acc/buy/mod/" type="button" class="block-options-item">
            ...
            <template #item-operation="{ code, type }">
              <div class="dropdown-center">
                ...
                <div aria-labelledby="dropdown-align-center-outline-primary" class="dropdown-menu dropdown-menu-end"
                  ...
                  <router-link class="dropdown-item" :to="'/acc/buy/view/' + code">
                ...
                <div class="row">
                  <div class="col-sm-6 com-md-6">
                    ...
                    <span class="text-primary">
                      ...
                      {{ localStorage.getItem('activeMoneyShortName') }}
                    </span>
                  </div>
