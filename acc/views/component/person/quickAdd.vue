...
<template>
    ...
    <button @click="loadData()" title="افزودن شخص جدید" type="button" class="btn-block-option" data-bs-toggle="modal"
        data-bs-target="#quickPersonAdd">
                    ...
                    <ul class="nav nav-tabs nav-tabs-alt" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button aria-controls="btabs-alt-static-home" aria-selected="true" class="nav-link active"
                                data-bs-target="#btabs-alt-static-home" data-bs-toggle="tab"
                                id="btabs-alt-static-home-tab" role="tab">
                                اطلاعات پایه </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button aria-controls="btabs-alt-static-profile" aria-selected="false" class="nav-link"
                                data-bs-target="#btabs-alt-static-profile" data-bs-toggle="tab"
                                id="btabs-alt-static-profile-tab" role="tab" tabindex="-1"> اطلاعات اقتصادی </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button aria-controls="btabs-alt-static-profile" aria-selected="false" class="nav-link"
                                data-bs-target="#btabs-alt-static-profile2" data-bs-toggle="tab"
                                id="btabs-alt-static-profile-tab2" role="tab" tabindex="-2"> اطلاعات تماس </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button aria-controls="btabs-alt-static-profile" aria-selected="false" class="nav-link"
                                data-bs-target="#btabs-alt-static-profile3" data-bs-toggle="tab"
                                id="btabs-alt-static-profile-tab3" role="tab" tabindex="-3"> آدرس </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button aria-controls="btabs-alt-static-profile" aria-selected="false" class="nav-link"
                                data-bs-target="#btabs-alt-static-profile4" data-bs-toggle="tab"
                                id="btabs-alt-static-profile-tab4" role="tab" tabindex="-4"> حساب‌های بانکی </button>
                        </li>
                    </ul>
                    <div class="block-content tab-content">
                        <div aria-labelledby="btabs-alt-static-home-tab" class="tab-pane active show"
                            id="btabs-alt-static-home" role="tabpanel" tabindex="0">
                            <div class="row">
                        ...
                        <div aria-labelledby="btabs-alt-static-profile-tab" class="tab-pane"
                            id="btabs-alt-static-profile" role="tabpanel" tabindex="0">
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-floating mb-4">
                        ...
                        <div aria-labelledby="btabs-alt-static-profile-tab2" class="tab-pane"
                            id="btabs-alt-static-profile2" role="tabpanel" tabindex="0">
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-floating mb-4">
                        ...
                        <div aria-labelledby="btabs-alt-static-profile-tab3" class="tab-pane"
                            id="btabs-alt-static-profile3" role="tabpanel" tabindex="0">
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-floating mb-4">
                        ...
                        <div aria-labelledby="btabs-alt-static-profile-tab4" class="tab-pane"
                            id="btabs-alt-static-profile4" role="tabpanel" tabindex="0">
                                ...
                                <div class="block block-rounded border border-gray mx-0 px-0">
                                    ...
                                    <div class="block-content">
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-floating mb-4">
                                                    <input v-model="person.accounts[index].bank" class="form-control"
                                                        type="text">
                                                    <label class="form-label"><span class="text-danger">(لازم)</span>
                                                        بانک </label>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-md-6">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-floating mb-4">
                                                    <input v-model="person.accounts[index].cardNum" class="form-control"
                                                        type="text">
