...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      component: () => import('../views/storeroom/io/buy.vue'),
    },
    {
      path: '/acc/storeroom/new/ticket/sell/:doc/:storeID',
      name: 'storeroom_new_ticket_sell',
      component: () => import('../views/storeroom/io/sell.vue'),
    },
    {
    ...
    },
    {
      ...
      name: 'order_list',
      component: () => import('../views/archive/orders_list.vue'),
    },
    {
      path: '/acc/shareholders/list',
      name: 'shareholders_list',
      component: () => import('../views/shareholder/list.vue'),
    },
    {
      path: "/:catchAll(.*)",
      name: "not-found",
