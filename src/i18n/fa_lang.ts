...
const fa_lang = {
  ...
  drawer: {
    ...
    buy_invoices: "فاکتور‌های خرید",
    sell_invoices: "فاکتور‌های فروش",
    rfbuy_invoices: "فاکتور‌های برگشت از خرید",
    rfsell_invoices: "فاکتور‌های برگشت از فروش",
    costs: "هزینه‌ها",
    incomes: "درآمد‌ها",
    ...
    avatar_settings: "نمایه کسب‌و‌کار",
    history: "تاریخچه",
