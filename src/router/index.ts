...
const router = createRouter({
    ...
    routes: [
        ...
        },
        {
            ...
            {
                path: 'reportchange/list',
                name: 'reportchange_list',
                component: () =>
                    import ('../views/manager/reportchange/list.vue')
            },
            {
                path: 'logs/list',
                name: 'logs_list',
                component: () =>
                    import ('../views/manager/log/logs.vue')
            },
            {
                path: 'reportchange/mod/:id?',
                name: 'reportchange_mod',
                component: () =>
                    import ('../views/manager/reportchange/mod.vue'),
            },
            {
                path: 'blog/list',
                name: 'blog_list',
                component: () =>
                    import ('../views/manager/blog/list.vue')
            },
            {
                path: 'support/list',
                name: 'support_list',
                component: () =>
                    import ('../views/manager/support/list.vue')
            },
            {
                path: 'support/view/:id',
                component: () =>
                    import ('../views/manager/support/show.vue'),
                meta: {
            ...
            {
                path: 'wallet/transaction/insert/:id',
                component: () =>
                    import ('../views/manager/wallet/mod.vue'),
                meta: {
                    'title': 'ثبت تراکنش',
                    'login': true
                }
            },
            {
                path: 'wallet/list',
                component: () =>
                    import ('../views/manager/wallet/list.vue'),
                meta: {
                    'title': 'لیست حساب‌ها',
                    'login': true
                }
            },
            {
                ...
                component: () =>
                    import ('../views/manager/wallet/transactions.vue'),
                meta: {
            ...
            },
            {
                path: 'users/list',
                component: () =>
                    import ('../views/manager/users/list.vue'),
                meta: {
                    'title': 'لیست کاربران',
                    'login': true
                }
            },
            {
                ...
                component: () =>
                    import ('../views/manager/users/change-password.vue'),
                meta: {
            ...
            },
            {
                path: 'business/list',
                component: () =>
                    import ('../views/manager/business/list.vue'),
                meta: {
            ...
            },
            {
                ...
                component: () =>
                    import ('../views/manager/settings/sms/smsSettings.vue'),
                meta: {
                    'title': 'تنظیمات پیامک',
                    'login': true
                }
            },
            {
                ...
                component: () =>
                    import ('../views/manager/settings/system.vue'),
                meta: {
                    'title': 'تنظیمات سیستم',
                    'login': true
                }
            },
            {
                ...
                component: () =>
                    import ('../views/manager/settings/update-center.vue'),
                meta: {
