<!-- src/components/widgets/TopIncomeCentersChart.vue -->
<template>
    <v-container fluid class="pt-0">
      <v-row density="compact" outlined justify="end">
...
export default {
  ...
  methods: {
    async fetchData() {
      this.isLoading = true;
      try {
        const response = await axios.get('/api/income/top-centers', {
        ...
        console.error('Error fetching top income centers:', error);
        this.series = [];
        this.chartOptions.labels = [];
      } finally {
