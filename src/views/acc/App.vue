...
import Icon from "./component/notifications/icon.vue";
import archive_modal from './component/archive/archive_modal.vue';
import Loading from "vue-loading-overlay";
import smsPanel from "./component/smsPanel.vue";
...
<template>
  <div
    class="rtl-support sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed page-footer-fixed main-content-full-width"
    id="page-container">
    <aside id="side-overlay" data-simplebar="init">
      <div class="simplebar-wrapper" style="margin: 0px;">
                ...
                <div class="bg-image" style="background-image: url('/img/bg_side_overlay_header.jpg');">
                  <div class="bg-primary-op">
                    <div class="content-header">
                      <!-- User Info -->
                      <div class="ms-2">
                        <a class="text-white fw-semibold" href="https://app.hesabix.ir/profile/dashboard">{{
                          userFullName
                        }}</a>
                      ...
                      <a class="ms-auto text-white" data-action="side_overlay_close" data-toggle="layout"
                  ...
                  <div class="block block-transparent pull-x pull-t mb-0">
                    <ul class="nav nav-tabs nav-tabs-block nav-justified" role="tablist">
                      <li class="nav-item" role="presentation">
                        <button aria-controls="so-profile" aria-selected="true" class="nav-link active"
                          data-bs-target="#so-profile" data-bs-toggle="tab" id="so-profile-tab" role="tab">
                          <i class="fa fa-ticket"></i>
                        </button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button aria-controls="so-settings" aria-selected="false" class="nav-link"
                          data-bs-target="#so-settings" data-bs-toggle="tab" id="so-settings-tab" role="tab"
                          tabindex="-1">
                    ...
                    <div class="block-content tab-content overflow-hidden pt-1">
                      <!-- Settings Tab -->
                      <div aria-labelledby="so-settings-tab" class="tab-pane pull-x fade fade-up" id="so-settings"
                        ...
                        <div class="block mb-0">
                            ...
                            <div class="row g-sm text-center">
                              <div class="col-6 mb-1">
                                <a class="d-block py-3 bg-body-dark fw-semibold text-dark"
                                  data-action="sidebar_style_dark" data-toggle="layout" href="javascript:void(0)"> تاریک
                                </a>
                              </div>
                              <div class="col-6 mb-1">
                                <a class="d-block py-3 bg-body-dark fw-semibold text-dark"
                                  data-action="sidebar_style_light" data-toggle="layout"
                                  href="javascript:void(0)">روشن</a>
                              </div>
                            </div>
                          </div>
                          <!-- END Sidebar -->
                          ...
                          <div class="block-content block-content-full">
                            <div class="row g-sm text-center mb-2">
                              <div class="col-6 mb-1">
                                <a class="d-block py-3 bg-body-dark fw-semibold text-dark"
                                  data-action="header_style_dark" data-toggle="layout" href="javascript:void(0)"> تاریک
                                </a>
                              </div>
                              <div class="col-6 mb-1">
                                <a class="d-block py-3 bg-body-dark fw-semibold text-dark"
                                  data-action="header_style_light" data-toggle="layout"
                                  href="javascript:void(0)">روشن</a>
                              </div>
                            </div>
                          </div>
                      ...
                      <!-- Profile -->
                      <div aria-labelledby="so-profile-tab" class="tab-pane pull-x fade fade-up show active"
                        id="so-profile" role="tabpanel" tabindex="0">
        ...
        <div class="simplebar-placeholder" style="width: auto; height: 1090px;"></div>
      </div>
      <div class="simplebar-track simplebar-horizontal" style="visibility: hidden;">
        <div class="simplebar-scrollbar" style="width: 0px; display: none;"></div>
      </div>
      <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
        <div class="simplebar-scrollbar" style="height: 33px; transform: translate3d(0px, 0px, 0px); display: block;">
        </div>
      </div>
    </aside>
    <!-- Sidebar -->
        ...
        <div class="content-header">
          ...
          <router-link class="fw-semibold text-white tracking-wide" to="/">
            ...
            <span class="smini-hidden"><span class="text-light">
                <img class="rounded-circle border img-fluid" style="max-width:35px; max-height:35px;background:white;"
                  :src="apiUrl + '/front/avatar/file/get/' + business.id" :alt="business.name" />
                {{ siteName }}
              </span>
            </span>
          </router-link>
          ...
          <div>
            ...
            <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
            <button class="me-1 btn btn-sm btn-alt-secondary d-lg-none" data-action="sidebar_close" data-toggle="layout"
              type="button">
              <i class="fa fa-times-circle"></i>
            </button>
            <!-- END Close Sidebar -->
      ...
      <div class="js-sidebar-scroll">
        ...
        <div class="content-side">
          <ul class="nav-main">
            ...
            <li v-show="(permissions.plugNoghreSell || permissions.plugNoghreAdmin) && (plugins.noghre !== undefined)"
              class="nav-main-item">
              ...
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                  <RouterLink class="nav-main-link" to="/acc/plugin/noghre/order/list">
                    ...
                    <RouterLink to="/acc/plugin/noghre/order/mod/0"
                      class="nav-main-link-badge badge rounded-pill bg-primary">+</RouterLink>
                  </RouterLink>
                  <RouterLink class="nav-main-link" to="/acc/plugin/noghre/employees/list">
                    ...
                    <RouterLink to="/acc/plugin/noghre/employees/mod"
                      class="nav-main-link-badge badge rounded-pill bg-primary">+</RouterLink>
                  </RouterLink>
                </li>
              </ul>
              ...
              <ul class="nav-main-submenu">
                ...
                <li v-if="permissions.getpay" class="nav-main-item">
                  <RouterLink class="nav-main-link" to="/acc/persons/receive/list">
                    ...
                    <RouterLink to="/acc/persons/receive/mod/"
                      class="nav-main-link-badge badge rounded-pill bg-primary">+
                    </RouterLink>
                  </RouterLink>
                </li>
                <li v-if="permissions.getpay" class="nav-main-item">
                  <RouterLink class="nav-main-link" to="/acc/persons/send/list">
                    ...
                    <router-link to="/acc/persons/send/mod/"
                ...
                <li class="nav-main-item">
                  <router-link class="nav-main-link" to="/acc/commodity/list">
                    <span class="nav-main-link-name">
                      ...
                      فهرست کالاها</span>
                    <router-link to="/acc/commodity/mod/"
                      class="nav-main-link-badge badge rounded-pill bg-primary">+</router-link>
                  </router-link>
                </li>
                <li class="nav-main-item">
                ...
                <li class="nav-main-item">
                  <router-link class="nav-main-link" to="/acc/commodity/drop/list">
                    <span class="nav-main-link-name">
                      ...
                      ویژگی‌های کالا</span>
                    <router-link to="/acc/commodity/drop/mod/"
                      class="nav-main-link-badge badge rounded-pill bg-primary">+</router-link>
                  </router-link>
                </li>
              </ul>
            </li>
            <li v-show="permissions.bank || permissions.cashdesk || permissions.salary || permissions.bankTransfer"
              class="nav-main-item">
              <a aria-expanded="false" aria-haspopup="true" class="nav-main-link nav-main-link-submenu"
                data-toggle="submenu" href="#">
              ...
              <ul class="nav-main-submenu">
                ...
                <li v-if="permissions.cashdesk" class="nav-main-item">
                  <RouterLink class="nav-main-link" to="/acc/cashdesk/list">
                    <span class="nav-main-link-name">
                      ...
                      صندوق‌ها</span>
                    <router-link to="/acc/cashdesk/mod/"
                      class="nav-main-link-badge badge rounded-pill bg-primary">+</router-link>
                  </RouterLink>
                </li>
                ...
                <li v-if="permissions.bankTransfer" class="nav-main-item">
                  <RouterLink class="nav-main-link" to="/acc/transfer/list">
                    ...
                    <RouterLink to="/acc/transfer/mod/" class="nav-main-link-badge badge rounded-pill bg-primary">+
                    </RouterLink>
                  </RouterLink>
                </li>
              </ul>
                ...
                <li class="nav-main-item">
                  <router-link class="nav-main-link" to="/acc/storeroom/list">
                    <span class="nav-main-link-name">
                      <i class="fa fa-boxes"></i>
                      انبارها</span>
                    <router-link to="/acc/storeroom/mod/"
                      class="nav-main-link-badge badge rounded-pill bg-primary">+</router-link>
                  </router-link>
                </li>
                <li class="nav-main-item">
                  <router-link class="nav-main-link" to="/acc/storeroom/tickets/list">
                    <span class="nav-main-link-name">
                      ...
                      حواله انبار</span>
                    <router-link to="/acc/storeroom/new/ticket/type"
                      class="nav-main-link-badge badge rounded-pill bg-primary">+</router-link>
                  </router-link>
                </li>
                <li class="nav-main-item">
                ...
                <li v-if="permissions.sell && this.isPluginActive('accpro') && 1 == 2" class="nav-main-item">
                  <router-link class="nav-main-link" to="/acc/presell/list/">
                    <span class="nav-main-link-name">
                      ...
                      پیش‌فاکتورها</span>
                    <router-link to="/acc/presell/mod/"
                      class="nav-main-link-badge badge rounded-pill bg-primary">+</router-link>
                  </router-link>
                </li>
                <li v-if="permissions.income" class="nav-main-item">
                  <RouterLink class="nav-main-link" to="/acc/incomes/list">
                    <span class="nav-main-link-name">
                      ...
                      فهرست درآمدها </span>
                    <router-link to="/acc/incomes/mod/"
                      class="nav-main-link-badge badge rounded-pill bg-primary">+</router-link>
                  </RouterLink>
                </li>
              </ul>
            ...
            <li
              ...
              <ul class="nav-main-submenu">
                <li v-if="permissions.archiveUpload || permissions.archiveMod || permissions.archiveDelete"
                  class="nav-main-item">
            ...
            <li class="nav-main-item" v-show="permissions.owner">
              <a aria-expanded="false" aria-haspopup="true"
                class="nav-main-link nav-main-link-submenu bg-success text-white" data-toggle="submenu" href="#">
          ...
          <div class="dropdown d-inline-block me-1">
            ...
            <div aria-labelledby="page-header-user-dropdown" class="dropdown-menu dropdown-menu-end p-0">
              ...
              <div class="p-2">
                ...
                <archive_modal />
                <div class="dropdown-divider" role="separator"></div>
                <a class="dropdown-item" data-action="side_overlay_toggle" data-toggle="layout"
